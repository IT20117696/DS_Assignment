    ...
    <div style={{ backgroundColor:"#2B3856" }} >
      <MainHomePageNavBar/> <br/><br/><br/>
         <div class="row d-flex align-items-center justify-content-center">
            <div style={{width: 900,background: "#F0F8FF",height:450}}>
               <div class="card-body" > 
                 <div class="container py-5 h-90" > 
                    <div class="row d-flex align-items-center justify-content-center h-100">      
              
                    <div class="col-md-9 col-lg-8 col-xl-5"> 
                <img src="https://theme.zdassets.com/theme_assets/9061094/0cabe51b71a9718c1f43028b11c83adb1a276109.png" class="img-fluid" alt="Phone image"/>
            <h2>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
               ...
               <div class="divider d-flex align-items-center my-4">
                     <span id="passwordHelpInline" class="form-text" style={{marginBottom:'2px'}}> 
                        <center><label >Not Registered? &nbsp;&nbsp;</label>
                            <a href='/admin/signup'>Sign Up</a></center>
                               </span>
                                   </div>             
                                </form>   
                              </div> 
